 ...
 * It replaces the old "sqlService".
 */
...
// Export alias for compatibility if needed, but App.tsx will be updated to use configService
export const sqlService = configService; 
